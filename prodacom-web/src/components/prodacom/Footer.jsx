...
export default function Footer() {
  ...
  function handleQuickLink(e, href) {
    e.preventDefault();
  ...
  function handleProductLink(e, id) {
    e.preventDefault();
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-white/30 leading-relaxed">
              Soluções integradas de controle de ponto e acesso. Tecnologia e confiabilidade há mais de 10 anos no mercado.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#contato" onClick={function (e) { handleQuickLink(e, "#contato"); }} className="text-xs text-white/20 hover:text-white/40 transition-colors cursor-pointer">Política de Privacidade</a>
            <a href="#contato" onClick={function (e) { handleQuickLink(e, "#contato"); }} className="text-xs text-white/20 hover:text-white/40 transition-colors cursor-pointer">Termos de Uso</a>
          </div>
        </div>
      </div>
    </footer>
